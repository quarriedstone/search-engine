...
def extract_categories(path):
    ...
    save_obj(categories, "categories")
    return categories


def lm_rank_documents(query, doc_ids, doc_lengths, high_low_index, smoothing='additive', param=0.1):
    """
...
def lm_define_categories(query, cat2docs, doc_lengths, high_low_index, smoothing="additive", param=0.1):
    """
